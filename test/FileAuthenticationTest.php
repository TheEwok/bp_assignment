<?php
	...
	class FileAuthenticationTest extends PHPUnit_Framework_TestCase {
		...
		*/
		...
		public function testShouldReturnFalseForInvalidIdentity() {
			...
			$this->_authenticate->authenticator->setCredential('password');
		...
		public function testShouldReturnFalseForInvalidCredential() {
			$this->_authenticate->authenticator->setIdentity('ewok');
		...
		public function testShouldReturnStringFromSession() {
			$this->_authenticate->authenticator->setIdentity('ewok');
			$this->_authenticate->authenticator->setCredential('password');
